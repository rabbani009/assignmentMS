                ...
                <table class="table table-striped table-responsive">
                    ...
                    <tr>
                       ...
                       @endif
                        ...
                        <td><strong>Total Resource person: </strong>{{ $activity->trainers }}</td>
                        <td><strong>Participants: </strong>{{ $activity->number_of_trainees }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><strong>Actual expenditure: </strong>{{ $activity->actual_budget_as_per_expenditure }}</td>
                        <td colspan="2"><strong>Council expenditure: </strong>{{ $activity->actual_expenditure_as_per_actual_budget }}</td>
                    </tr>
                    <tr>
