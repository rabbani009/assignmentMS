        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="row">
                      <!-- Assignment ID -->
                      <div class="col-md-4">
                        <div class="form-group @if ($errors->has('assignment_id')) has-error @endif">
                            <label for="">Assignment ID *</label>
                            <input type="number" name="assignment_id" class="form-control @if($errors->has('subject')) is-invalid @endif" value="{{ old('subject') }}" placeholder="Enter subject Name">
                            @if($errors->has('assignment_id'))
                                <span class="error invalid-feedback">{{ $errors->first('assignment_id') }}</span>
                            @else
